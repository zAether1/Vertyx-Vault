...
function SubmissionReview({ item, onModerate, onSave }: { item: ContentSubmission; onModerate: (id: string, action: 'approve' | 'reject') => void; onSave: (id: string, playbackUrl: string, playbackKind: PlaybackKind) => Promise<string | undefined> }) {
