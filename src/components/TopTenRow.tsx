    ...
    <>
      <div className="px-4 md:px-8 lg:px-12 mb-2">
        <h1 className="flex flex-col md:flex-row items-start md:items-center ml-2 md:ml-0">
          <div className="flex">
            <span className="text-6xl md:text-8xl font-bold text-[#8f5bd7] leading-none">T</span>
            <span className="text-6xl md:text-8xl font-bold text-[#8f5bd7] leading-none ml-1">O</span>
            <span className="text-6xl md:text-8xl font-bold text-[#8f5bd7] leading-none ml-1">P</span>
          </div>
          <div className="text-[#eee9f4] uppercase tracking-wider font-medium ml-1 md:ml-4 text-sm md:text-base">
            <div>{variant}</div>
            <div>HOY</div>
          </div>
            ...
            >
              {items.map((item) => (
                <button
                  ...
                  className="cursor-pointer min-w-[140px] sm:min-w-[180px] md:min-w-[200px] relative group/item p-0 bg-transparent border-none text-left rounded-lg focus:outline-none focus:ring-4 focus:ring-[#8f5bd7] focus:ring-opacity-75 transition-all duration-200"
                >
                  <div className="relative">
                    <div className="absolute -left-10 sm:-left-12 md:-left-14 top-2/3 -translate-y-1/2 z-30 transition-all duration-300 group-hover/item:scale-110 group-hover/item:-translate-x-1">
                      <span
                        className="text-[80px] sm:text-[100px] md:text-[120px] font-bold text-transparent group-hover/item:text-[#8f5bd7] drop-shadow-lg select-none pointer-events-none transition-all duration-300"
                        style={{
                          WebkitTextStroke: '2px rgba(201, 168, 240, .9)',
                    ...
                    <div className="overflow-hidden rounded-lg relative z-20 transition-all duration-300 group-hover/item:shadow-[0_0_22px_rgba(143,91,215,0.34)]">
                      ...
                      <div className="absolute inset-0 border-2 border-[#8f5bd7] rounded-lg opacity-0 group-hover/item:opacity-100 transition-opacity duration-300"></div>
                    </div>
                  </div>
                </button>
              ))}
