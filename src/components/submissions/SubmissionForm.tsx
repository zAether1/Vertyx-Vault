...
export default function SubmissionForm() {
  ...
  if (!signedIn) return <section className="vault-submission-lock"><div className="vault-submission-lock__icon"><CirclePlayIcon className="h-6 w-6" /></div><div><span className="vault-page__eyebrow">Acceso editorial</span><h2>Tu cuenta habilita las propuestas</h2><p>Los invitados pueden explorar y organizar su biblioteca. Crea una cuenta local para proponer títulos al equipo editorial.</p><Link href="/profile" className="vault-action">Ir a mi perfil</Link></div></section>;
