...
export default function MediaPlayer({ source, title, initialTime = 0, onProgress }: Props) {
  ...
  if (useIframeFallback && source) return <iframe className="vp__frame" src={source.url} title={title} allow="autoplay; fullscreen; picture-in-picture; xr-spatial-tracking; clipboard-write" allowFullScreen webkitAllowFullScreen mozAllowFullScreen />;
  ...
  if (source.kind === 'embed') return <iframe className="vp__frame" src={source.url} title={source.title} allow="autoplay; fullscreen; picture-in-picture; xr-spatial-tracking; clipboard-write" allowFullScreen webkitAllowFullScreen mozAllowFullScreen />;
