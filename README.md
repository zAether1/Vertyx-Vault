...
- El archivo contiene 197 bloques comentados, uno por cada título actual, con su nombre, tipo e ID.
...
No es necesaria una API de catálogo para estas URLs: el registro local se consulta antes que cualquier proveedor remoto opcional.
